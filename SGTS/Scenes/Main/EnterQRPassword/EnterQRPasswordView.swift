...
protocol EnterQRPasswordViewOutput: AnyObject,
                                    TextCellWithTitleAtBorderViewModelOutput,
                                    NextStepButtonViewModelOutput { }

protocol EnterQRPasswordViewLogic: UIView {
    func update(viewModel: EnterQRPasswordModel.ViewModel)
//    func displayWaitIndicator(viewModel: EnterQRPasswordFlow.OnWaitIndicator.ViewModel)
    
    var output: EnterQRPasswordViewOutput? { get set }
}


final class EnterQRPasswordView: UIView, EnterQRPasswordViewLogic, SpinnerDisplayable {
...
//    }
    ...
    private(set) var viewModel: EnterQRPasswordModel.ViewModel?
    ...
    weak var output: EnterQRPasswordViewOutput?
...
extension EnterQRPasswordView: UITableViewDataSource {
