...
protocol SetPinCodeViewOutput: AnyObject,
                                    TextCellWithTitleAtBorderViewModelOutput,
                                    SwitchBiometryCellViewModelOutput,
                                    NextStepButtonViewModelOutput { }

protocol SetPinCodeViewLogic: UIView {
    func update(viewModel: SetPinCodeModel.ViewModel)
//    func displayWaitIndicator(viewModel: SetPinCodeFlow.OnWaitIndicator.ViewModel)

    var output: SetPinCodeViewOutput? { get set }
}


final class SetPinCodeView: UIView, SetPinCodeViewLogic, SpinnerDisplayable {
    ...
    private(set) var viewModel: SetPinCodeModel.ViewModel?
    ...
    weak var output: SetPinCodeViewOutput?
...
extension SetPinCodeView: UITableViewDataSource {
